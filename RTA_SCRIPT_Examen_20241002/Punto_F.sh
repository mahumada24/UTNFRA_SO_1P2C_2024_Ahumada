...
echo -n "El hash de mi Usuario es: " | sudo tee -a ~/repogit/UTNFRA_SO_1P2C_2024_Ahumada/RTA_ARCHIVOS_Examen_20241005/Filtro_Avanzado.txt && sudo grep $(whoami) /etc/shadow | sudo awk -F ':' '{print $2}' | sudo tee -a ~/repogit/UTNFRA_SO_1P2C_2024_Ahumada/RTA_ARCHIVOS_Examen_20241005/Filtro_Avanzado.txt
